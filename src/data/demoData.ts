...
export const DEMO_OFFERS: Offer[] = [
  { offerId: 'o1', restaurantId: 'r1', restaurantName: 'Rasika', linkedCampaignId: 'c5', code: 'SPOT-RASIKA', type: 'qr', description: '15% off when you show this QR to your server', landingPageUrl: '#', scans: 342, redemptions: 48, scansBySource: { instagram: 189, tiktok: 97, direct: 56 }, isActive: true, createdAt: demoISO(-30), expiresAt: demoDate(30) },
  { offerId: 'o2', restaurantId: 'r6', restaurantName: "Rose's Luxury", code: 'SPOT20ROSES', type: 'promo', description: '$20 off your first visit — use code at checkout', landingPageUrl: '#', scans: 0, redemptions: 186, scansBySource: { instagram: 120, web: 66 }, isActive: true, createdAt: demoISO(-60) },
  { offerId: 'o3', restaurantId: 'r3', restaurantName: 'The Dabney', linkedCampaignId: 'c3', code: 'spot-dabney-spring', type: 'link', description: 'Track visits from The Dabney spring campaign', landingPageUrl: '#', scans: 215, redemptions: 32, scansBySource: { tiktok: 140, instagram: 50, direct: 25 }, isActive: true, createdAt: demoISO(-14), expiresAt: demoDate(45) },
  { offerId: 'o4', restaurantId: 'r2', restaurantName: 'Bad Saint', code: 'SPOT-BS', type: 'qr', description: 'Complimentary dessert with entree purchase', landingPageUrl: '#', scans: 520, redemptions: 123, scansBySource: { instagram: 310, youtube: 120, direct: 90 }, isActive: false, createdAt: demoISO(-45), expiresAt: demoDate(-5) },
  { offerId: 'o5', restaurantId: 'r12', restaurantName: 'Le Diplomate', code: 'BRUNCH-DIPLO', type: 'promo', description: 'Free mimosa with brunch — use code at checkout', landingPageUrl: '#', scans: 0, redemptions: 67, scansBySource: { instagram: 42, web: 25 }, isActive: true, createdAt: demoISO(-5), expiresAt: demoDate(20) },
];
