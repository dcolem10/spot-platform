...
export const DEMO_OFFERS: Offer[] = [
  { offerId: 'o1', restaurantId: 'r1', restaurantName: 'Rasika', linkedCampaignId: 'c5', code: 'SPOT-RASIKA', type: 'qr', description: '15% off when you show this QR to your server', landingPageUrl: '#', scans: 342, redemptions: 48, scansBySource: { instagram: 189, tiktok: 97, direct: 56 }, isActive: true, createdAt: demoISO(-30), expiresAt: demoDate(30), approvalStatus: 'approved', mutuallyApproved: true, approvedAt: demoISO(-28) },
  { offerId: 'o2', restaurantId: 'r6', restaurantName: "Rose's Luxury", code: 'SPOT20ROSES', type: 'promo', description: '$20 off your first visit — use code at checkout', landingPageUrl: '#', scans: 0, redemptions: 186, scansBySource: { instagram: 120, web: 66 }, isActive: true, createdAt: demoISO(-60), approvalStatus: 'approved', mutuallyApproved: true },
  ...
  { offerId: 'o4', restaurantId: 'r2', restaurantName: 'Bad Saint', code: 'SPOT-BS', type: 'qr', description: 'Complimentary dessert with entree purchase', landingPageUrl: '#', scans: 520, redemptions: 123, scansBySource: { instagram: 310, youtube: 120, direct: 90 }, isActive: false, createdAt: demoISO(-45), expiresAt: demoDate(-5), approvalStatus: 'paused_by_restaurant', pausedBy: 'restaurant', pauseReason: 'Menu update in progress' },
  { offerId: 'o5', restaurantId: 'r12', restaurantName: 'Le Diplomate', code: 'BRUNCH-DIPLO', type: 'promo', description: 'Free mimosa with brunch — use code at checkout', landingPageUrl: '#', scans: 0, redemptions: 67, scansBySource: { instagram: 42, web: 25 }, isActive: true, createdAt: demoISO(-5), expiresAt: demoDate(20), approvalStatus: 'creator_only' },
  // Marketplace: a restaurant-published deal open for creators to adopt.
  { offerId: 'o6', restaurantId: 'r7', restaurantName: 'Tail Up Goat', code: 'SPOT-TUG-OPEN', type: 'qr', description: '20% off for your followers — show this at the table', landingPageUrl: '#', scans: 0, redemptions: 0, scansBySource: {}, isActive: true, createdAt: demoISO(-3), expiresAt: demoDate(60), approvalStatus: 'published', origin: 'restaurant', adoptedCount: 4 },
  // Marketplace: an offer a creator already adopted from a restaurant deal.
  { offerId: 'o7', restaurantId: 'r9', restaurantName: 'Maydan', code: 'SPOT-MAYDAN-A1', type: 'qr', description: 'Free spread starter with any entrée', landingPageUrl: '#', scans: 88, redemptions: 19, scansBySource: { instagram: 60, tiktok: 28 }, isActive: true, createdAt: demoISO(-9), expiresAt: demoDate(40), approvalStatus: 'approved', mutuallyApproved: true, origin: 'restaurant_adopted', parentOfferId: 'tpl-maydan' },
];
