...
export const DEMO_OFFERS: Offer[] = [
  { offerId: 'o1', restaurantId: 'r1', restaurantName: 'Rasika', linkedCampaignId: 'c5', code: 'SPOT-RASIKA', type: 'qr', description: '15% off when you show this QR to your server', terms: { discountType: 'percent', discountValue: 15 }, landingPageUrl: '#', scans: 342, redemptions: 48, scansBySource: { instagram: 189, tiktok: 97, direct: 56 }, isActive: true, createdAt: demoISO(-30), expiresAt: demoDate(30), approvalStatus: 'approved', mutuallyApproved: true, approvedAt: demoISO(-28) },
  { offerId: 'o2', restaurantId: 'r6', restaurantName: "Rose's Luxury", code: 'SPOT20ROSES', type: 'promo', description: '$20 off your first visit — use code at checkout', terms: { discountType: 'fixed', discountValue: 20 }, landingPageUrl: '#', scans: 0, redemptions: 186, scansBySource: { instagram: 120, web: 66 }, isActive: true, createdAt: demoISO(-60), approvalStatus: 'approved', mutuallyApproved: true },
  { offerId: 'o3', restaurantId: 'r3', restaurantName: 'The Dabney', linkedCampaignId: 'c6', code: 'spot-dabney-spring', type: 'link', description: 'Track visits from The Dabney spring campaign', landingPageUrl: '#', scans: 215, redemptions: 32, scansBySource: { tiktok: 140, instagram: 50, direct: 25 }, isActive: true, createdAt: demoISO(-14), expiresAt: demoDate(45), approvalStatus: 'pending_restaurant' },
  { offerId: 'o4', restaurantId: 'r2', restaurantName: 'Bad Saint', code: 'SPOT-BS', type: 'qr', description: 'Complimentary dessert with entree purchase', terms: { discountType: 'freeItem', discountValue: 0, freeItemDescription: 'dessert' }, landingPageUrl: '#', scans: 520, redemptions: 123, scansBySource: { instagram: 310, youtube: 120, direct: 90 }, isActive: false, createdAt: demoISO(-45), expiresAt: demoDate(-5), approvalStatus: 'paused_by_restaurant', pausedBy: 'restaurant', pauseReason: 'Menu update in progress' },
  { offerId: 'o5', restaurantId: 'r12', restaurantName: 'Le Diplomate', code: 'BRUNCH-DIPLO', type: 'promo', description: 'Free mimosa with brunch — use code at checkout', terms: { discountType: 'freeItem', discountValue: 0, freeItemDescription: 'mimosa' }, landingPageUrl: '#', scans: 0, redemptions: 67, scansBySource: { instagram: 42, web: 25 }, isActive: true, createdAt: demoISO(-5), expiresAt: demoDate(20), approvalStatus: 'creator_only' },
  // Marketplace: a restaurant-published deal open for creators to adopt.
  { offerId: 'o6', restaurantId: 'r7', restaurantName: 'Tail Up Goat', code: 'SPOT-TUG-OPEN', type: 'qr', description: '20% off for your followers — show this at the table', terms: { discountType: 'percent', discountValue: 20 }, landingPageUrl: '#', scans: 0, redemptions: 0, scansBySource: {}, isActive: true, createdAt: demoISO(-3), expiresAt: demoDate(60), approvalStatus: 'published', origin: 'restaurant', adoptedCount: 4 },
  // Marketplace: an offer a creator already adopted from a restaurant deal.
  { offerId: 'o7', restaurantId: 'r9', restaurantName: 'Maydan', code: 'SPOT-MAYDAN-A1', type: 'qr', description: 'Free spread starter with any entrée', terms: { discountType: 'freeItem', discountValue: 0, freeItemDescription: 'spread starter' }, landingPageUrl: '#', scans: 88, redemptions: 19, scansBySource: { instagram: 60, tiktok: 28 }, isActive: true, createdAt: demoISO(-9), expiresAt: demoDate(40), approvalStatus: 'approved', mutuallyApproved: true, origin: 'restaurant_adopted', parentOfferId: 'tpl-maydan' },
];

/* ─── Deals (Insider) ──────────────────────────────────────────────────────── */

export const DEMO_DEALS: DealOffer[] = [
  // Code-backed deals ride the attributed offer system: claiming one reveals a
  // real tracked promo code — the viewer's incentive AND the attribution event.
  { dealId: 'dl1', restaurantId: 'r1', restaurantName: 'Rasika', title: '15% Off Dinner for Two', description: 'Enjoy 15% off your dinner bill when dining as a party of 2 or more. Valid Sunday through Thursday.', insiderOnly: true, expiresAt: demoDate(14), code: 'SPOT-RASIKA', terms: { discountType: 'percent', discountValue: 15, validDays: ['Sun', 'Mon', 'Tue', 'Wed', 'Thu'] }, source: 'offer' },
  ...
  { dealId: 'dl3', restaurantId: 'r3', restaurantName: 'The Dabney', title: 'Complimentary Dessert', description: 'Enjoy a complimentary dessert course with any tasting menu order.', insiderOnly: true, expiresAt: demoDate(21), code: 'SPOT-DABNEY-D4', terms: { discountType: 'freeItem', discountValue: 0, freeItemDescription: 'dessert course' }, source: 'offer' },
  { dealId: 'dl4', restaurantId: 'r12', restaurantName: 'Le Diplomate', title: 'Free Mimosa at Brunch', description: 'One complimentary mimosa with any brunch entree purchase. Weekends only.', insiderOnly: false, expiresAt: demoDate(10), code: 'BRUNCH-DIPLO', terms: { discountType: 'freeItem', discountValue: 0, freeItemDescription: 'mimosa' }, source: 'offer' },
  { dealId: 'dl5', restaurantId: 'r10', restaurantName: 'Thip Khao', title: '$10 Off Your First Visit', description: 'New visitors get $10 off orders of $40 or more. Show this deal at checkout.', insiderOnly: false, expiresAt: demoDate(7), code: 'SPOT-THIPKHAO', terms: { discountType: 'fixed', discountValue: 10, minSpend: 40 }, source: 'offer' },
  { dealId: 'dl6', restaurantId: 'r14', restaurantName: 'Ambar', title: 'Unlimited Small Plates', description: 'Upgrade to the unlimited small plates experience for free with any drink purchase.', insiderOnly: false, terms: { discountType: 'freeItem', discountValue: 0, freeItemDescription: 'small plates upgrade' } },
];
